...
import { NeoPowerBIService } from './neo-power-bi.service';
...
@Component({
  selector: 'neo-power-bi',
  template: '<div #neoPowerBIIFrame style="height:100%; width: 100%;"></div>',
  styles: []
})
export class NeoPowerBIComponent
  ...
  private powerBiService: NeoPowerBIService;

  constructor(private NeoPowerBIService: NeoPowerBIService) {
